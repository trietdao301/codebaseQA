...
export async function* parseCodeBase(rootDir: string) : AsyncGenerator<IndexProgress> {
    await Parser.init();
    ...
    for(let i = 0; i < filePaths.length; i++){
        ...
        const parsedFile: ParsedFile = { filePath: filePath, source: source, tree: tree, grammar: grammar };
        parsedFiles.push(parsedFile);
        yield { stage: 'parsing', file: filePath, count: i + 1, total: filePaths.length, parsed: parsedFile };
    }
}
